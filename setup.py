...
ext_modules = [
    Extension(
        "pymt_avulsion.lib._bmi",
        ["pymt_avulsion/lib/_bmi.pyx"],
        language="c",
...
pymt_components = [("Avulsion=pymt_avulsion.lib:Avulsion", "meta")]

setup(
    name="pymt_avulsion",
    author="Eric Hutton",
    description="PyMT plugin avulsion",
